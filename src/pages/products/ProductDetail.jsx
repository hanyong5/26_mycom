...
export default function ProductDetail() {
  ...
  if (notFound) return (
    <div className="text-center py-20">
      ...
      <Link to="/products"><Button variant="ghost">목록으로</Button></Link>
    </div>
  )

  return (
    <div className="max-w-[1200px] mx-auto px-5 md:px-10 py-10">
      <Link to="/products" className="text-sm text-gray-400 hover:text-primary mb-6 inline-block">← 제품 목록</Link>
